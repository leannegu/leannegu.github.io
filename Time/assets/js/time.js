...
// Update time
  function update() {
    ...
    function checkHalfMinute(momentMinute){
      if(momentMinute < 30) {halfMinute = 'halfH';}

      else if(momentMinute > 29){halfMinute = 'secondhalfH';}
    ...
    var timeAll = ['s' + momentSecond, 'm' + momentMinute, 'h' + momentHour, momentAMPM, momentDay, momentMonth, 'y' + momentYear, oddSecond, oddMinute, halfSecond, halfMinute, halfHour];
    ...
    // Add format
    $('.time').html(moment().format('h:mm:ss:SS A'));
